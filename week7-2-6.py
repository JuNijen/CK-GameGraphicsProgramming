...
while running:
    ...
    _matrix7_2_size_result = np.matmul(_matrix7_2, _matrix7_2_size)
...
,    ])
    ...
    _matrix7_2_rotation_result = np.matmul(_matrix7_2_size_result, _matrix7_2_roation)
    ...
    for i in range (0, 4, 1):
        _matrix7_2_shear_result[i] = np.matmul(_matrix7_2_shear, _matrix7_2_rotation_result[i])
