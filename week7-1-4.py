...
while running:
    ...
    _matrix7_1_rotation_result = np.matmul(_matrix7_1, _matrix7_1_roation)


    # 좌표계 변경
    for i in range (0, 4, 1):
        _matrix7_1_rotation_result[i] = (
            screenWidth/2 + _matrix7_1_rotation_result[i][0],
            screenHeight/2 - _matrix7_1_rotation_result[i][1]
            )


    # 선형 변환 실습 1-2
    pygame.draw.polygon(screen, (255, 0, 0), _matrix7_1_rotation_result)
